...
import type { ResponsiveCapabilities, ResponsiveState } from '@/infrastructure/platform'
import { MEDIA_QUERIES, deriveResponsiveState } from '@/infrastructure/platform'
